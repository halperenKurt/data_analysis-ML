# -*- coding: utf-8 -*-
"""
Created on Fri Jul 12 10:49:32 2024
...
plt.plot(X_test, regr_1_pred,color="blue", label="Max Depth:2", linewidth=2)
plt.plot(X_test, regr_2_pred,color="green", label="Max Depth:10", linewidth=2)
plt.xlabel("data")
plt.ylabel("target")
plt.legend()
