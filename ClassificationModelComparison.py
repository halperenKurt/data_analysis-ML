...
for ds_cnt, ds in enumerate(datasets):
    ...
    if ds_cnt == 0:
        ...
        #plot training data
        plt.scatter(X_train[:,0],X_train[:,1],c=y_train, cmap=cm_bright, edgecolors="black")
        
        #plot test data
        plt.scatter(X_train[:,0],X_train[:,1],c=y_train,cmap=cm_bright,edgecolors="black",alpha=0.6)
